(function(){
  ...
  const ROUTES = Object.freeze({
    ...
    'logistica-produccion':{css:['./modules/logistica-produccion/logistica-produccion.css?v=20260923-pvo-nuevo-busqueda-calendario-v001'],js:['./modules/logistica-produccion/logistica-produccion.js?v=20260923-pvo-nuevo-busqueda-calendario-v001']},
    'logistica-produccion-nuevo':{css:['./modules/logistica-produccion/logistica-produccion.css?v=20260923-pvo-nuevo-busqueda-calendario-v001'],js:['./modules/logistica-produccion/logistica-produccion.js?v=20260923-pvo-nuevo-busqueda-calendario-v001']},
    'logistica-produccion-detalle':{css:['./modules/logistica-produccion/logistica-produccion.css?v=20260923-pvo-nuevo-busqueda-calendario-v001'],js:['./modules/logistica-produccion/logistica-produccion.js?v=20260923-pvo-nuevo-busqueda-calendario-v001']},
    'logistica-pvo':{css:['./modules/logistica-produccion/logistica-produccion.css?v=20260923-pvo-nuevo-busqueda-calendario-v001'],js:['./modules/logistica-produccion/logistica-produccion.js?v=20260923-pvo-nuevo-busqueda-calendario-v001']},
    'logistica-documentos':{css:['./modules/logistica-produccion/logistica-produccion.css?v=20260923-pvo-nuevo-busqueda-calendario-v001'],js:['./modules/logistica-produccion/logistica-produccion.js?v=20260923-pvo-nuevo-busqueda-calendario-v001']},
    ...
    'almacen-stock':{css:[ALMACEN_MODULE_CSS,ALMACEN_REABASTO_CSS],js:[ALMACEN_MODULE_JS,ALMACEN_REABASTO_JS]},
  ...
  function bootstrapSeguimientoEspecial(){
    loadScript(SEGUIMIENTO_ESPECIAL_GLOBAL_JS).catch(error=>{
      console.error('[SEGUIMIENTO_ESPECIAL_BOOTSTRAP]',error);
    });
  }
