(function(){
  ...
  const ROUTES = Object.freeze({
    ...
    'logistica-produccion':{css:['./modules/logistica-produccion/logistica-produccion.css?v=20260831-v003'],js:['./modules/logistica-produccion/logistica-produccion.js?v=20260831-v003']},
    'logistica-produccion-nuevo':{css:['./modules/logistica-produccion/logistica-produccion.css?v=20260831-v003'],js:['./modules/logistica-produccion/logistica-produccion.js?v=20260831-v003']},
    'logistica-produccion-detalle':{css:['./modules/logistica-produccion/logistica-produccion.css?v=20260831-v003'],js:['./modules/logistica-produccion/logistica-produccion.js?v=20260831-v003']},
    'logistica-pvo':{css:['./modules/logistica-produccion/logistica-produccion.css?v=20260831-v003'],js:['./modules/logistica-produccion/logistica-produccion.js?v=20260831-v003']},
    'logistica-documentos':{css:['./modules/logistica-produccion/logistica-produccion.css?v=20260831-v003'],js:['./modules/logistica-produccion/logistica-produccion.js?v=20260831-v003']},
    ...
    'ventas-dashboard':{css:['./modules/ventas-dashboard/ventas-dashboard.css?v=20260831-botones-seccion-v002'],js:['./modules/ventas-dashboard/ventas-dashboard-pdf.js?v=20260805-b4-v001','./modules/ventas-dashboard/ventas-dashboard.js?v=20260831-botones-seccion-v002']},
