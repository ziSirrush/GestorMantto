(function(){
  ...
  function humanDateText(value){
    ...
    return window.ManttoHumanTime&&typeof window.ManttoHumanTime.formatDateTime==='function'
      ? window.ManttoHumanTime.formatDateTime(value,{fallback:escapeHtml(fallback)})
      : escapeHtml(fallback);
  }
