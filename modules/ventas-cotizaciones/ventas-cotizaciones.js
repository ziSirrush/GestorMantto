...
const STATUS=['Contacto','En Cotizacion','Sin Respuesta','Seguimiento con Probabilidad','En Espera de Definicion','Pre Asignado','Asignado','En Contrato','Vendido','Perdido','Siguiente Año','Borrar'];
const state={page:1,pageSize:25,totalPages:1,rows:[],kpis:null,catalogs:{asesores:[],administrativos:[],zonas:[],anios:[],relaciones_admin:[]},visibility:{acceso_total:false,modo:'LIMITED',usuario_id:null,ids_asesores_visibles:[]},selected:null};
...
const headers=(json=false)=>Object.assign({'Accept':'application/json'},json?{'Content-Type':'application/json'}:{},window.ManttoAuth&&window.ManttoAuth.authHeaders?window.ManttoAuth.authHeaders():{});
