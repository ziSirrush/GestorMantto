(function(){
  const MODULE_VERSION = '20260921-proyectos-llamadas-completo-v003';
  const state = {
    loaded:false,
    filtersLoaded:false,
    rows:[],
