...
Presentar desempeño operativo por supervisor, preventivos y validaciones Vo.Bo.
...
```text
src/modules/dashboard-operativo/
...
├── dashboard-operativo.contract.js
├── dashboard-operativo.validator.js
├── dashboard-operativo.constants.js
├── README.md
└── CHANGELOG.md
```
...
- `GET /api/tickets (fuente compartida para métricas Vo.Bo.)`
