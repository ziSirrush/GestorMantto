...
Gestionar perfil, directorio, roles, zonas, preferencias y relaciones administrativas.

## 2. Dominio y empresa

- **Dominio:** Compartido
- **Estado actual:** Desarrollo / parcialmente implementado
- **Estado de congelación:** Aplican las reglas generales del proyecto.

## 3. Propietario físico actual

`src/routes/usuarios.routes.js`, `usuarios-rel-admin.routes.js` y sus controladores
...
- `GET/POST/DELETE /api/usuarios-rel-admin`
