...
Gestionar el seguimiento de cobranza de Corellian. Su backend dedicado aún no está confirmado.

## 2. Dominio y empresa

- **Dominio:** Corellian
- **Estado actual:** Planeado / sin módulo backend dedicado confirmado
- **Estado de congelación:** Aplican las reglas generales del proyecto.

## 3. Propietario físico actual

No se confirmó una ruta/controlador dedicado en `backend(10).zip`

## 4. Propietario físico objetivo

```text
src/modules/cobranza/
├── cobranza.routes.js
├── cobranza.controller.js
├── cobranza.service.js
├── cobranza.repository.js
├── cobranza.contract.js
├── cobranza.validator.js
├── cobranza.constants.js
├── README.md
└── CHANGELOG.md
```
...
- No hay endpoints dedicados confirmados.

## 6. Dependencias de base de datos identificadas

- No puedo confirmar tablas propietarias con el backend revisado
