...
Calcular y presentar criticidad, fallas y MTBC de equipos y proyectos.
...
```text
src/modules/equipos-criticos/
├── equipos-criticos.routes.js
├── equipos-criticos.controller.js
├── equipos-criticos.service.js
├── equipos-criticos.repository.js
├── equipos-criticos.contract.js
├── equipos-criticos.validator.js
├── equipos-criticos.constants.js
├── README.md
└── CHANGELOG.md
```
