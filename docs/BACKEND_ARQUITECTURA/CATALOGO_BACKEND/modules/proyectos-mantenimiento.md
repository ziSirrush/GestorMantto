...
Listar proyectos de mantenimiento y sus indicadores agregados.
...
```text
src/modules/proyectos-mantenimiento/
├── proyectos-mantenimiento.routes.js
├── proyectos-mantenimiento.controller.js
├── proyectos-mantenimiento.service.js
├── proyectos-mantenimiento.repository.js
├── proyectos-mantenimiento.contract.js
├── proyectos-mantenimiento.validator.js
├── proyectos-mantenimiento.constants.js
├── README.md
└── CHANGELOG.md
```
