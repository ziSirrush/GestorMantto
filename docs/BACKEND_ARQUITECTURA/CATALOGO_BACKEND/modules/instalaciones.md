...
Gestionar instalaciones, proyectos, fotografías y concentrados de clientes.
...
`src/routes/ins-fl.routes.js` + `src/controllers/ins-fl.controller.js`

## 4. Propietario físico objetivo

```text
src/modules/instalaciones/
├── instalaciones.routes.js
├── instalaciones.controller.js
├── instalaciones.service.js
├── instalaciones.repository.js
├── instalaciones.contract.js
├── instalaciones.validator.js
├── instalaciones.constants.js
├── README.md
└── CHANGELOG.md
```
...
- `GET /api/ins-fl`
- `GET /api/ins-fl/proyectos`
- `GET /api/ins-fl/proyectos/fotografias`
- `PATCH /api/ins-fl/proyectos/fotografias/:id_ppns/principal`
- `GET /api/ins-fl/proyectos/concentrado-clientes`
- `GET /api/ins-fl/:id`
