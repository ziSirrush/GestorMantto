...
Administrar permisos granulares, roles, impersonación y configuración del sistema. La implementación formal está pendiente.

## 2. Dominio y empresa

- **Dominio:** Compartido
- **Estado actual:** Pendiente / base parcial
- **Estado de congelación:** Aplican las reglas generales del proyecto.

## 3. Propietario físico actual

Actualmente distribuido en `data.controller.js`, `usuarios.controller.js` y rutas administrativas

## 4. Propietario físico objetivo

```text
src/modules/panel-control/
├── panel-control.routes.js
├── panel-control.controller.js
├── panel-control.service.js
├── panel-control.repository.js
├── panel-control.contract.js
├── panel-control.validator.js
├── panel-control.constants.js
├── README.md
└── CHANGELOG.md
```
...
- `GET /api/zonas`
- `GET /api/usuario-zop`
- `Rutas administrativas de usuarios y relaciones`
