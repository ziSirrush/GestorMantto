...
Entregar KPIs, distribuciones, equipos y tickets de un proyecto.
...
```text
src/modules/detalle-proyecto/
├── detalle-proyecto.routes.js
├── detalle-proyecto.controller.js
├── detalle-proyecto.service.js
├── detalle-proyecto.repository.js
├── detalle-proyecto.contract.js
├── detalle-proyecto.validator.js
├── detalle-proyecto.constants.js
├── README.md
└── CHANGELOG.md
```
