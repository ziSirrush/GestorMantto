...
Presentar indicadores U365 y rankings operativos de proyectos y equipos.
...
`src/routes/data.routes.js` + `src/controllers/criticos.controller.js`

## 4. Propietario físico objetivo

```text
src/modules/dashboard-call-center/
├── dashboard-call-center.routes.js
├── dashboard-call-center.controller.js
├── dashboard-call-center.service.js
├── dashboard-call-center.repository.js
├── dashboard-call-center.contract.js
├── dashboard-call-center.validator.js
├── dashboard-call-center.constants.js
├── README.md
└── CHANGELOG.md
```
