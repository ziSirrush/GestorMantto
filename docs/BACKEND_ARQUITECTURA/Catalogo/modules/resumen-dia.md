...
Presentar el resumen operativo diario y la tabla contextual de tickets.
...
```text
src/modules/resumen-dia/
├── resumen-dia.routes.js
├── resumen-dia.controller.js
├── resumen-dia.service.js
├── resumen-dia.repository.js
├── resumen-dia.contract.js
├── resumen-dia.validator.js
├── resumen-dia.constants.js
├── README.md
└── CHANGELOG.md
```
