...
Gestionar campana, histórico y estado nuevo/abierto de notificaciones.
...
├── notificaciones.repository.js
├── notificaciones.contract.js
├── notificaciones.validator.js
├── notificaciones.constants.js
├── README.md
└── CHANGELOG.md
```
