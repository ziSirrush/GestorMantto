...
Presentar KPIs, filtros y clasificación comercial del portafolio.
...
```text
src/modules/dashboard-portafolio/
├── dashboard-portafolio.routes.js
├── dashboard-portafolio.controller.js
├── dashboard-portafolio.service.js
├── dashboard-portafolio.repository.js
├── dashboard-portafolio.contract.js
├── dashboard-portafolio.validator.js
├── dashboard-portafolio.constants.js
├── README.md
└── CHANGELOG.md
```
