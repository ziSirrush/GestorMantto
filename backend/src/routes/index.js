...
const instalacionesBitacoraRoutes = require('../modules/instalaciones-bitacora/instalaciones-bitacora.routes');
...
router.use('/logistica/dashboard', logisticaDashboardRoutes);
...
router.use('/instalaciones', instalacionesBitacoraRoutes);
